...
<nav>
  <ul>
    <li>
      <a href="#content-sectioning">Content sectioning</a>
      <ul>
        <li>
    ...
    <li>
      ...
      <ul>
        ...
        <li>
          <a href="#dl-dt-dd">&lt;dl&gt;, &lt;dt&gt;, &lt;dd&gt;</a>
        </li>
        <li>
          <a href="#div">&lt;div&gt;</a>
        </li>
        <li>
          <a href="#figure-figcaption">&lt;figure&gt;, &lt;figcaption&gt;</a>
        </li>
        <li>
          <a href="#hr">&lt;hr&gt;</a>
        </li>
    ...
    <li>
      <a href="#inline-text-semantics">Inline text semantics</a>
      <ul>
        <li>
          <a href="#a">&lt;a&gt;</a>
        </li>
    ...
    <li>
      <a href="#image-and-multimedia">Image and multimedia</a>
      <ul>
        <li>
    ...
    <li>
      <a href="#demarcating-edits">Demarcating edits</a>
      <ul>
        <li>
          <a href="#del">&lt;del&gt;</a>
        </li>
    ...
    <li>
      <a href="#table-content">Table content</a>
      <ul>
        <li>
    ...
    <li>
      ...
      <ul>
        ...
        <li>
          <a href="#fieldset-legend">&lt;fieldset&gt;, &lt;legend&gt;</a>
        </li>
        <li>
          <a href="#form">&lt;form&gt;</a>
        </li>
...
<section id="text-content">
  ...
  <section id="blockquote">
    ...
    <blockquote>
      <p>Quote with &lt;p&gt; tags</p>
      <footer>
        <cite>And with &lt;cite&gt; inside the footer</cite>
      </footer>
    </blockquote>
    <blockquote>
  ...
  <section id="figure-figcaption">
    ...
    <figure>
      <blockquote>
        &lt;blockquote&gt; example &lt;blockquote&gt; example &lt;blockquote&gt;
        example &lt;blockquote&gt; example &lt;blockquote&gt; example
        &lt;blockquote&gt; example &lt;blockquote&gt; example &lt;blockquote&gt;
        example
      </blockquote>
...
<section id="inline-text-semantics">
  ...
  <section id="abbr">
    <h3>&lt;abbr&gt;</h3>
    <abbr title="Example">Example</abbr>
  </section>
  <section id="b">
    <h3>&lt;b&gt;</h3>
    <b>Example</b>
  ...
  <section id="code">
    <h3>&lt;code&gt;</h3>
    <code>Example</code>
    <pre><code>Long long long long long long long long code within a &lt;pre&gt; tag</code></pre>
    <pre><code>Short code within a &lt;pre&gt; tag</code></pre>
    <p>
  ...
  <section id="data">
    <h3>&lt;data&gt;</h3>
    <data value="example">Example</data>
  </section>
  <section id="dfn">
    <h3>&lt;dfn&gt;</h3>
    <dfn>Example</dfn>
  ...
  <section id="kbd">
    ...
    <p>And now for some bug tests:</p>
    <p>
      <kbd
        ><kbd
          ><kbd
                                                                                      ...
                                                                                      ><kbd
                                                                                        ><kbd
                                                                                          ><kbd
                                                                                            ><kbd
                                                                                              ><kbd
                                                                                                ><kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd></kbd
      ></kbd>
    </p>
    <p>
      <kbd
    ...
    <p>
      <kbd><img src="https://i.stack.imgur.com/qHeff.jpg" alt="" /></kbd
      ><kbd><img src="https://i.stack.imgur.com/qHeff.jpg" alt="" /></kbd>
    </p>
    <p>
      <kbd
        ><img src="https://i.stack.imgur.com/qHeff.jpg" alt="" /><img
          src="https://i.stack.imgur.com/qHeff.jpg"
          alt=""
      /></kbd>
    </p>
  </section>
  ...
  <section id="time">
    ...
    <time datetime="2004-09-22T16:16:00+1000"
      >September 22, 2004, at 4:16 PM</time
    >
  </section>
  <section id="u">
    <h3>&lt;u&gt;</h3>
...
<section id="buttons">
  ...
  <section id="button">
    ...
    <button type="button">🙂 emoji-left</button>
    <button type="button">🙂</button>
    <button type="button">emoji-right 🙂</button>
  ...
  <section id="button-input">
    ...
    <input type="button" value="🙂 emoji-left" />
    <input type="button" value="🙂" />
    <input type="button" value="emoji-right 🙂" />
    <input type="reset" />
    <input type="submit" />
    <input
      type="image"
    ...
    <input type="reset" disabled value="Disabled Reset" />
    <input type="submit" disabled value="Disabled Submit" />
    <input
      type="image"
      disabled
      src="https://via.placeholder.com/70x36"
...
<section id="forms">
  ...
  <section id="input">
    ...
    <input id="label-after-checkbox-example" type="checkbox" />
    <label for="label-after-checkbox-example">Label after checkbox</label>
    <input
      id="label-after-disabled-checkbox-example"
      type="checkbox"
      disabled
    />
    <label for="label-after-disabled-checkbox-example"
      >Label after disabled checkbox</label
    >
    <input type="color" />
    <input type="color" disabled />
    <input type="color" required />
    <input type="date" />
    <input type="date" value="2004-09-22" />
    <input type="date" value="2004-09-22" disabled />
    <input type="date" value="2004-09-22" readonly />
    <input type="date" value="2004-09-22" required />
    <input type="datetime-local" />
    <input type="datetime-local" value="2004-09-22T16:16:00" />
    <input type="datetime-local" value="2004-09-22T16:16:00" disabled />
    <input type="datetime-local" value="2004-09-22T16:16:00" readonly />
    <input type="datetime-local" value="2004-09-22T16:16:00" required />
    <input type="email" />
    <input type="email" placeholder="Placeholder" />
    <input type="email" value="example@example.com" />
    <input value="disabled@example.com" disabled />
    <input value="readonly@example.com" readonly />
    <input value="required@example.com" required />
    <input type="file" />
    ...
    <input id="label-after-radio-example" type="radio" name="example" />
    <label for="label-after-radio-example">Label after radio</label>
    <input
      id="label-after-disabled-radio-example"
      type="radio"
      name="example"
      disabled
    />
    <label for="label-after-disabled-radio-example"
      >Label after disabled radio</label
    >
    <input type="range" value="5" min="0" max="10" />
    <input type="range" value="5" min="0" max="10" disabled />
    <input type="search" />
    <input type="search" value="Example" />
    <input type="search" value="Disabled" disabled />
    <input type="search" value="Readonly" readonly />
    <input type="search" value="Required" required />
    <input type="tel" />
    <input type="tel" value="+61 2 5550 6077" />
    <input type="tel" value="+61 2 5550 6077" disabled />
    <input type="tel" value="+61 2 5550 6077" readonly />
    <input type="tel" value="+61 2 5550 6077" required />
    <input type="time" />
    <input type="time" value="16:16:00" />
    <input type="time" value="16:16:00" disabled />
    <input type="time" value="16:16:00" readonly />
    <input type="time" value="16:16:00" required />
    <input type="url" />
    <input type="url" value="https://example.com" />
    <input type="url" value="https://example.com/disabled" disabled />
    <input type="url" value="https://example.com/readonly" readonly />
    <input type="url" value="https://example.com/required" required />
    <input type="week" />
    <input type="week" value="2004-W39" />
    <input type="week" value="2004-W39" disabled />
    <input type="week" value="2004-W39" readonly />
    <input type="week" value="2004-W39" required />
  </section>
  <section id="label">
    <h3>&lt;label&gt;</h3>
    <label for="label-example">Example</label>
...
<section id="interactive-elements">
  ...
  <section id="dialog">
    ...
    <button
      type="button"
      onclick="document.querySelector('#dialog-example').showModal()"
    >
      Open dialog
    </button>
